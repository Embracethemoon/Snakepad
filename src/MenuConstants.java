/**
 * Interface storing string constants for menu's text.
 */
public interface MenuConstants{
    ...
    String formatTabWidth = "Set Tab Width to 8";

    String viewStatusBar = "Status Bar";

    String helpHelpTopic = "Help Topic";
    String helpAboutNotepad = "About SnakePad";

    String aboutText = "SnakePad Beta";
}